...
window.CHAMPION_APP_VERSION = "17";
  ...
  window.firebaseLogin=(identifier,password)=>{
    ...
    loginPromise=(async()=>{
      ...
      try{
        ...
        if(loginPorEmail){
          // Gestor e aluno entram diretamente pelo e-mail cadastrado.
          cred=await auth.signInWithEmailAndPassword(
            identificador.toLowerCase(),
            senhaDigitada
          );
        }else{
          // Professor entra com o CPF cadastrado.
          ...
          try{
            ...
            throw new Error(
              "CPF ou senha do professor inválidos. A senha inicial são os 6 primeiros números do CPF."
            );
          }
        }
